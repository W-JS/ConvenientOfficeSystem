...
!function (V) {
    ...
    var e, t, n, r, i, a, u, s, c, l, f, m, g, p, h, v, y = function (n) {
            ...
            toString: q("none()")
        }, Object.freeze && Object.freeze(r), r), N = function (n) {
            var e = q(n), t = function () {
                return o
            }, r = function (e) {
                return e(n)
            }, o = {
        ...
        }, S = E("string"), T = E("object"), k = E("array"), A = E("null"), R = E("boolean"), D = E("function"),
        O = E("number"), B = Array.prototype.slice, P = Array.prototype.indexOf, I = Array.prototype.push,
        L = function (e, t) {
            return P.call(e, t)
        }, F = function (e, t) {
            return -1 < L(e, t)
            ...
            return B.call(e)
        }, ne = "undefined" != typeof V.window ? V.window : Function("return this;")(), re = function (e, t) {
            return function (e, t) {
        ...
        }, ue = V.navigator, se = ue.userAgent, ce = function (e) {
    ...
    var le, fe = {
        ...
        y.bind = function (e, t, n, r) {
            var o, i, a, u, s, c, l, f = V.window, d = function (e) {
                C(Ne(e || f.event), o)
            };
    ...
    var Te, ke, _e, Ae, Re, De, Oe, Be, Pe, Ie, Le, Fe, Me, ze, Ue, je, Ve, He, qe = "sizzle" + -new Date,
        $e = V.window.document, We = 0, Ke = 0, Xe = Tt(), Ye = Tt(), Ge = Tt(), Je = function (e, t) {
            return e === t && (Le = !0), 0
        ...
        }, vt = /^(?:input|select|textarea|button)$/i, yt = /^h\d$/i, bt = /^[^{]+\{\s*\[native \w/,
        Ct = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, xt = /[+~]/, wt = /'|\\/g,
    ...
    function zt(e) {
        for (var r, t, n, o = e.length, i = _e.relative[e[0].type], a = i || _e.relative[" "], u = i ? 1 : 0, s = It(function (e) {
            ...
            if ((t = _e.filter[e[u].type].apply(null, e[u].matches))[qe]) {
                ...
                return Mt(1 < u && Lt(l), 1 < u && Pt(e.slice(0, u - 1).concat({value: " " === e[u - 2].type ? "*" : ""})).replace(lt, "$1"), t, u < n && zt(e.slice(u, n)), n < o && zt(e = e.slice(n)), n < o && Pt(e))
            }
            l.push(t)
        }
        return Lt(l)
    ...
    var Ut = Array.isArray, jt = function (e, t, n) {
            var r, o;
            if (!e) return 0;
            ...
            isArray: Ut, toArray: function (e) {
                ...
                return n
            }, findIndex: Vt, find: function (e, t, n) {
                var r = Vt(e, t, n);
            ...
            trim: $t, isArray: Ht.isArray, is: Wt, toArray: Ht.toArray, makeMap: function (e, t, n) {
                var r;
                for (t = t || ",", "string" == typeof (e = e || []) && (e = e.split(t)), n = n || {}, r = e.length; r--;) n[e[r]] = {};
                return n
            }, each: Ht.each, map: Ht.map, grep: Ht.filter, inArray: Ht.indexOf, hasOwn: function (e, t) {
        ...
        }, Yt = V.document, Gt = Array.prototype.push, Jt = Array.prototype.slice,
    ...
    var En, Sn, Tn, kn, _n, An, Rn, Dn = function (e, t) {
            ...
            nu: Bn, detect: function (e, t) {
                var n = String(t).toLowerCase();
                return 0 === e.length ? On() : Dn(e, n)
            }, unknown: On
        }, In = "Firefox", Ln = function (e, t) {
            return function () {
                return t === e
            }
        }, Fn = function (e) {
            ...
            firefox: q(In),
            safari: q("Safari")
        }, zn = "Windows", Un = "Android", jn = "Solaris", Vn = "FreeBSD", Hn = function (e, t) {
            return function () {
                return t === e
            }
        }, qn = function (e) {
        ...
        }, Qn = /.*?version\/\ ?([0-9]+)\.([0-9]+).*/, Zn = function (t) {
            return function (e) {
                return Yn(e, t)
            }
        }, er = [{
            ...
            name: "Chrome", versionRegexes: [/.*?chrome\/([0-9]+)\.([0-9]+).*/, Qn], search: function (e) {
            ...
            name: "Safari", versionRegexes: [Qn, /.*?cpu os ([0-9]+)_([0-9]+).*/], search: function (e) {
            ...
            search: Zn("sunos"),
            versionRegexes: []
        }, {name: "FreeBSD", search: Zn("freebsd"), versionRegexes: []}], nr = {browsers: q(er), oses: q(tr)},
        rr = function (e) {
            var t, n, r, o, i, a, u, s, c, l, f, d = nr.browsers(), m = nr.oses(), g = Kn(d, e).fold(Mn.unknown, Mn.nu),
            ...
            fromHtml: function (e, t) {
                ...
                return ir(n)
            }, fromDom: ir, fromPoint: function (e, t, n) {
                var r = e.dom();
        ...
        sr = (V.Node.DOCUMENT_TYPE_NODE, V.Node.DOCUMENT_FRAGMENT_NODE, V.Node.ELEMENT_NODE), cr = V.Node.TEXT_NODE,
        lr = (V.Node.PROCESSING_INSTRUCTION_NODE, V.Node.ENTITY_REFERENCE_NODE, V.Node.ENTITY_NODE, V.Node.NOTATION_NODE, function (e) {
        ...
        }, dr = fr(sr), mr = fr(cr), gr = Object.keys, pr = Object.hasOwnProperty, hr = function (e, t) {
            ...
            var n, r, o = e.dom(), i = V.window.getComputedStyle(o).getPropertyValue(t),
        ...
        }, Jr = (Ar("element", "offset"), or.detect().browser), Qr = function (e) {
            return X(e, dr)
        }, Zr = {
    ...
    var no = to.exports.boltExport, ro = function (e) {
        var n = _.none(), t = [], r = function (e) {
            o() ? a(e) : t.push(e)
        }, o = function () {
            return n.isSome()
        }, i = function (e) {
        ...
        return {
            is: function (e) {
                return n === e
            }, isValue: C, isError: b, getOr: q(n), getOrThunk: q(n), getOrDie: q(n), or: function (e) {
                return lo(n)
            }, orThunk: function (e) {
                return lo(n)
            }, fold: function (e, t) {
        ...
        return {
            is: b, isValue: b, isError: C, getOr: $, getOrThunk: function (e) {
                return e()
            }, getOrDie: function () {
                ...
                return fo(e(n))
            }, each: o, bind: function (e) {
                return fo(n)
            }, exists: b, forall: C, toOption: _.none
        }
    }, mo = {
        value: lo, error: fo, fromOption: function (e, t) {
    ...
    var po, ho, vo, yo = function (t) {
        ...
        }, Po = Ro(3), Io = Ro(8), Lo = Ro(9), Fo = Ro(11), Mo = Oo("br"), zo = Bo("true"), Uo = Bo("false"), jo = {
            isText: Po,
            isElement: Do,
            isComment: Io,
            isDocument: Lo,
        ...
        }, qo = {trimNode: Ho}, $o = Xt.makeMap,
        Wo = /[&<>\"\u0060\u007E-\uD7FF\uE000-\uFFEF]|[\uD800-\uDBFF][\uDC00-\uDFFF]/g,
        Ko = /[<>&\u007E-\uD7FF\uE000-\uFFEF]|[\uD800-\uDBFF][\uDC00-\uDFFF]/g, Xo = /[<>&\"\']/g,
        Yo = /&#([a-z0-9]+);?|&([a-z0-9]+);/gi, Go = {
            128: "\u20ac",
            130: "\u201a",
            131: "\u0192",
            132: "\u201e",
    ...
    var Qo = function (e, t) {
            ...
            }, encodeNumeric: Zo, encodeNamed: ei, getEncodeFunc: function (e, t) {
                var n = Jo(t) || po, r = $o(e.replace(/\+/g, ","));
        ...
        }, ni = {}, ri = {}, oi = Xt.makeMap, ii = Xt.each, ai = Xt.extend, ui = Xt.explode, si = Xt.inArray,
        ci = function (e, t) {
            ...
            var r;
            return e && (r = {}, "string" == typeof e && (e = {"*": e}), ii(e, function (e, t) {
    ...
    function di(i) {
        ...
        var S = function (e) {
            ...
            ni[i.schema] = null, e && ii(ci(e, ","), function (e) {
                var t, n, r = o.exec(e);
                r && (n = r[1], t = n ? g[r[2]] : g[r[2]] = {"#comment": {}}, t = g[r[2]], ii(ci(r[3], "|"), function (e) {
                    "-" === n ? delete t[e] : t[e] = {}
                }))
            })
        }, w = function (e) {
    ...
    var pi, hi = Xt.each, vi = Xt.grep, yi = fe.ie, bi = /^([a-z0-9],?)+$/i, Ci = /^[ \t\r\n]*$/,
        xi = function (n, r, o) {
    ...
    function Ei(a, u) {
        var s, c = this;
        void 0 === u && (u = {});
        var r = {}, i = V.window, o = {}, t = 0, e = function (m, g) {
                void 0 === g && (g = {});
                var p, h = 0, v = {};
                p = g.maxLoadTime || 5e3;
                var y = function (e) {
            ...
            }(a, {contentCssCors: u.contentCssCors}), l = [], f = u.schema ? u.schema : di({}),
            ...
            g = gn.overrideDefaults(function () {
            ...
            }, O = ti.decode, B = ti.encodeAllRaw, P = function (e, t) {
                var n = h(e);
                ...
                getViewPort: function (e) {
                    var t = e || i, n = t.document.documentElement;
                    return {
    ...
    var Si = Ei, Ti = Si.DOM, ki = Xt.each, _i = Xt.grep, Ai = function (e) {
    ...
    var ea, ta = function (e, t, n) {
        ...
        }, aa = q("mce-annotation"), ua = q("data-mce-annotation"), sa = q("data-mce-annotation-uid"),
        ca = function (r, e) {
            var t = r.selection.getRng(), n = ar.fromDom(t.startContainer), o = ar.fromDom(r.getBody()),
                i = e.fold(function () {
                    return "." + aa()
                }, function (e) {
                    return "[" + ua() + '="' + e + '"]'
                }), a = Xr(n, t.startOffset).getOr(n), u = ia(a, i, function (e) {
                    return Mr(e, o)
                }), s = function (e, t) {
            ...
            var n, r, o, a = Hi({}), c = function (e, t) {
                u(e, function (e) {
                    return t(e), e
                })
            }, u = function (e, t) {
                var n = a.get(), r = t(n.hasOwnProperty(e) ? n[e] : {listeners: [], previous: Hi(_.none())});
                n[e] = r, a.set(n)
            }, t = (n = function () {
                var e, t, n, r = a.get(), o = (e = gr(r), (n = B.call(e, 0)).sort(t), n);
                z(o, function (e) {
                    u(e, function (u) {
            ...
            var n, r, o = Ur(e).dom(), i = ar.fromDom(o.createDocumentFragment()),
        ...
        }, Na = jo.isElement, Ea = jo.isText, Sa = function (e) {
            ...
            var t, n
        }, Ia = jo.isContentEditableTrue, La = jo.isContentEditableFalse, Fa = jo.isBr, Ma = jo.isText,
        za = jo.matchNodeNames("script style textarea"),
        Ua = jo.matchNodeNames("img input textarea hr iframe video audio object"), ja = jo.matchNodeNames("table"),
        Va = ka, Ha = function (e) {
        ...
        }, uu = jo.isElement, su = Ha, cu = jo.matchStyleValues("display", "block table"),
        lu = jo.matchStyleValues("float", "left right"), fu = iu(uu, su, y(lu)),
        du = y(jo.matchStyleValues("white-space", "pre pre-line pre-wrap")), mu = jo.isText, gu = jo.isBr,
        pu = Si.nodeIndex, hu = eu, vu = function (e) {
    ...
    function Su(t, n, e) {
        ...
        return {
            container: q(t), offset: q(n), toRange: function () {
                var e;
    ...
    var Tu, ku, _u = Su, Au = jo.isText, Ru = jo.isBogus, Du = Si.nodeIndex, Ou = function (e) {
            var t = e.parentNode;
            return Ru(t) ? Ou(t) : t
        }, Bu = function (e) {
        ...
        }, Uu = jo.isContentEditableFalse, ju = function (e, t, n, r, o) {
            ...
            getBookmark: function (e, t, n) {
                ...
                }) : t ? {rng: e.getRng()} : Xu(e, !1);
                var r, o
            }, getUndoBookmark: d(Wu, $, !0), getPersistentBookmark: Xu
        }, Gu = "_mce_caret", Ju = function (e) {
            ...
            return null
        }, Zu = jo.isElement, es = jo.isText, ts = function (e) {
            var t = e.parentNode;
            t && t.removeChild(e)
        }, ns = function (e, t) {
        ...
        }, cs = or.detect().browser, ls = jo.isContentEditableFalse, fs = function (e, t, n) {
            ...
            var t, s, c = Hi(_.none()), l = function () {
                !function (e) {
                    var t, n, r, o, i;
            ...
            return {
                show: function (t, e) {
                    ...
                    return c.set(_.some({caret: i, element: e, before: t})), c.get().each(function (e) {
        ...
        hs = jo.matchStyleValues("display", "block table table-cell table-caption list-item"), vs = ka, ys = Sa,
        bs = jo.isElement, Cs = Ha, xs = function (e) {
            return 0 < e
        }, ws = function (e) {
            return e < 0
        }, Ns = function (e, t) {
            ...
            return null
        }, Rs = d(_s, !0), Ds = d(_s, !1), Os = function (e, t, n) {
            var r, o, i, a, u = d(As, !0, t), s = d(As, !1, t);
    ...
    var Ms, zs, Us, js = jo.isContentEditableFalse, Vs = jo.isText, Hs = jo.isElement, qs = jo.isBr, $s = Ha,
        Ws = function (e) {
            return Ua(e) || !!qa(t = e) && !0 !== j(te(t.getElementsByTagName("*")), function (e, t) {
                return e || Ia(t)
            }, !1);
            var t
        }, Ks = $a, Xs = function (e, t) {
            ...
            isInlineBlock: bc, moveStart: function (e, t, n) {
            ...
            }, isWhiteSpaceNode: Cc, replaceVars: function (e, n) {
            ...
            }, normalizeStyleValue: xc, getStyle: function (e, t, n) {
        ...
        }, Nc = yc, Ec = wc.getParents, Sc = wc.isWhiteSpaceNode, Tc = wc.isTextBlock, kc = function (e, t) {
            ...
            var a = [], u = Uc(i.getDoc(), r, t, n), s = Hi(_.none()), c = function () {
                s.set(_.none())
            }, l = function (e) {
                z(e, o)
            }, o = function (e) {
            ...
            s.undoManager.transact(function () {
                ...
                if (o.collapsed && (r = Pc(e = s, t = o, [{inline: !0}], 3 === (n = t).startContainer.nodeType && n.startContainer.nodeValue.length >= n.startOffset && "\xa0" === n.startContainer.nodeValue[n.startOffset]), t.setStart(r.startContainer, r.startOffset), t.setEnd(r.endContainer, r.endOffset), e.selection.setRng(t)), s.selection.getRng().collapsed) {
                    ...
                    var a = Yu.getPersistentBookmark(s.selection, !1), u = s.selection.getRng();
            ...
            register: function (e, t) {
                ...
                var t, n, r, o, i, a,
                    u = (t = s, n = e, r = ar.fromDom(t.getBody()), o = Qi(r, "[" + ua() + '="' + n + '"]'), i = {}, z(o, function (e) {
                        var t = Er(e, sa()), n = i.hasOwnProperty(t) ? i[t] : [];
                        i[t] = n.concat([e])
                    }), i);
                return a = function (e) {
    ...
    var qc = function (e) {
        ...
        var n = _u.after(e), r = Js(t).prev(n);
        ...
        var n, r, a, u, s, c, l, f, d, m, g, p, h, v, y, b, C, x, w,
            ...
            E = Kc(o, i.startContainer), S = Wc(qc(N.firstChild)), T = o.getRoot(), k = function (e) {
                var t = _u.fromRangeStart(i), n = Js(o.getRoot()), r = 1 === e ? n.prev(t) : n.next(t);
    ...
    var ul, sl = function (a) {
            var u = _u.fromRangeStart(a), s = _u.fromRangeEnd(a), c = a.commonAncestorContainer;
        ...
        }, ll = jo.matchNodeNames("td th"), fl = function (e, t) {
            ...
            }(g.getRng(), t)), r = e.parser, m = n.merge, o = al({validate: e.settings.validate}, e.schema), d = '<span id="mce_marker" data-mce-type="bookmark">&#xFEFF;&#x200B;</span>', s = {
                content: t,
                format: "html",
                selection: !0,
                paste: n.paste
            ...
            return ru(sc.firstPositionIn(u), sc.lastPositionIn(u), function (e, t) {
                var n = Vl.normalizePosition(!0, e), r = Vl.normalizePosition(!1, t), o = Vl.normalizePosition(!1, a);
            ...
            var n, r, o, i = ar.fromDom(e), a = ar.fromDom(t);
            ...
            var n, r, o
        }, Xl = jo.hasAttribute("data-mce-bookmark"), Yl = jo.hasAttribute("data-mce-bogus"),
        Gl = jo.hasAttributeValue("data-mce-bogus", "all"), Jl = function (e) {
            return function (e) {
                var t, n, r = 0;
                if (Kl(e, e)) return !1;
        ...
        }, Ql = Ar("block", "position"), Zl = Ar("from", "to"), ef = function (e, t) {
            var n = ar.fromDom(e), r = ar.fromDom(t.container());
            return Hl(n, r).map(function (e) {
                return Ql(e, t)
            })
        }, tf = function (o, i, e) {
            var t = ef(o, _u.fromRangeStart(e)), n = t.bind(function (e) {
            ...
            return zr(t, e) ? function (e, t) {
                for (var n = D(t) ? t : b, r = e.dom(), o = []; null !== r.parentNode && r.parentNode !== undefined;) {
                    var i = r.parentNode, a = ar.fromDom(i);
            ...
            var n, r, o, t, i = ar.fromDom(e.getBody()), a = e.selection.getRng();
            ...
            var r = U(uf(ar.fromDom(n.container()), t), Co), o = Z(r).getOr(t);
            ...
            var n
        }, Tf = d(Nf, !1), kf = d(Nf, !0), _f = (ul = "\xa0", function (e) {
            return ul === e
        }), Af = function (e) {
            return /^[\r\n\t ]$/.test(e)
        }, Rf = function (e) {
        ...
        Vf = function (e, t, n, r) {
            ...
            var n, r, o, i, a = Hr(e).filter(mr), u = qr(e).filter(mr);
            ...
            void 0 === r && (r = !0);
            var o, i, a = Qf(n, t.getBody(), e.dom()), u = ta(e, d(ed, t), (o = t.getBody(), function (e) {
                return e.dom() === o
        ...
        }, md = d(dd, !0), gd = d(dd, !1), pd = function (e, t) {
        ...
        Cd = function (e, t) {
            ...
            var r = Vl.normalizeForwards(n), o = Cd(t, r.container());
            ...
            var r = Vl.normalizeBackwards(n), o = Cd(t, r.container());
            return Vl.findRootInline(e, o, r).fold(function () {
            ...
            var e = Vl.normalizePosition(a, c), l = _d(u, s, e);
        ...
        }, Ld = _d, Fd = Id, Md = (d(Id, !1), d(Id, !0), Dd), zd = function (e) {
            ...
            var n = t.selection.getRng(), r = e ? _u.fromRangeEnd(n) : _u.fromRangeStart(n);
            ...
            }, moveNextWord: d(Kd, !0), movePrevWord: d(Kd, !1), setupSelectedState: function (a) {
                var u = Hi(null), s = d(Vl.isInlineTarget, a);
            ...
            var u = r.getBody(), s = d(Vl.isInlineTarget, r);
            ...
            var e, t, a = (e = n.getBody(), t = o.container(), Ss(t, e) || e), u = d(Vl.isInlineTarget, n), s = Ld(u, a, o);
            return s.bind(function (e) {
                ...
                var t = sc.navigate(i, a, o), e = t.bind(function (e) {
                    return Ld(u, a, e)
                });
                return s.isSome() && e.isSome() ? Vl.findRootInline(u, a, o).map(function (e) {
                    return o = e, !!ru(sc.firstPositionIn(o), sc.lastPositionIn(o), function (e, t) {
                        var n = Vl.normalizePosition(!0, e), r = Vl.normalizePosition(!1, t);
            ...
            return !1
        }, Zd = Ar("start", "end"), em = Ar("rng", "table", "cells"),
        tm = xf([{removeTable: ["element"]}, {emptyCells: ["cells"]}]), nm = function (e, t) {
            ...
            var t = nm(e.startContainer, r), n = nm(e.endContainer, r);
            ...
            var n, r, o, i, a, u = ar.fromDom(e.selection.getStart(!0)), s = xm(e);
            ...
            matchNode: Fm, matchName: Im, match: function (e, t, n, r) {
                var o;
        ...
        }, jm = xa, Vm = "_mce_caret", Hm = function (e) {
            return 0 < function (e) {
                for (var t = []; e;) {
            ...
            return Nr(t, {id: Vm, "data-mce-bogus": "1", "data-mce-type": "format-caret"}), e && Fi(t, ar.fromText(jm)), t
        }, Wm = function (e, t, n) {
            void 0 === n && (n = !0);
            ...
            var r = e.dom, o = r.getParent(n, d(wc.isTextBlock, e));
            ...
            var o, i, a, u, s = d(Qm, t), c = W(U(r, s), function (e) {
                return e.dom()
            });
            ...
            var t, e = ar.fromDom(r.getBody()), n = ar.fromDom(r.selection.getStart()),
        ...
        }, ag = jo.isContentEditableTrue, ug = jo.isContentEditableFalse, sg = function (e, t, n, r, o) {
            ...
            var r = Os(1, e.getBody(), t), o = _u.fromRangeStart(r), i = o.getNode();
            ...
            return function (e, t) {
                ...
                var r = t ? Tu.Forwards : Tu.Backwards, o = Js(e.getBody()), i = d(Ls, o.next), a = d(Ls, o.prev),
                    u = t ? i : a, s = t ? Lf : Ff, c = Ps(r, e.getBody(), n), l = Vl.normalizePosition(t, u(c));
                if (!l) return !1;
            ...
            getFontSize: bg("font-size"), getFontFamily: H(function (e) {
                return e.replace(/[\'\"\\]/g, "").replace(/,\s+/g, ",")
            }, bg("font-family")), toPt: function (e, t) {
            ...
            var n = t.collapsed, r = t.cloneRange(), o = Su.fromRangeStart(t);
        ...
        Wg = {
            domRange: $g.domRange, relative: $g.relative, exact: $g.exact, exactFromRange: function (e) {
        ...
        }, Kg = or.detect().browser, Xg = function (e, t) {
        ...
        }, fp = Xt.each, dp = Xt.extend, mp = Xt.map, gp = Xt.inArray;
    ...
    var yp, bp = function (n) {
        ...
        }, Fp = Lp = Xt.extend({}, Cp, Lp), Mp = Ar("sections", "settings"), zp = or.detect().deviceType.isTouch(),
        Up = ["lists", "autolink", "autosave"], jp = {theme: "mobile"}, Vp = function (e) {
            var t = k(e) ? e.join(" ") : e, n = W(S(t) ? t.split(" ") : [], Gn);
            ...
            var o, i = Vp(n.forced_plugins), a = Vp(r.plugins), u = e && Hp(t, "mobile") ? U(a, d(F, Up)) : a,
    ...
    var Zp = function (e) {
        ...
        }, sh = ih, ch = function (e, t) {
            return t.dom()[e]
        }, lh = function (e, t) {
            return parseInt(kr(t, e), 10)
        }, fh = d(ch, "clientWidth"), dh = d(ch, "clientHeight"), mh = d(lh, "margin-top"), gh = d(lh, "margin-left"),
        ph = function (e, t, n) {
    ...
    var bh = {}, Ch = "en", xh = {
    ...
    }, wh = Bi.PluginManager, Nh = function (e, t) {
        var n = function (e, t) {
        ...
        }, displayError: Sh, initError: Th
    }, _h = Bi.PluginManager, Ah = Bi.ThemeManager;
    ...
    }, Fh = Bh, Mh = 0, zh = function (e) {
        return (e || "blobid") + Mh++
    }, Uh = function (n, r, o, t) {
        var i, a;
        0 !== r.src.indexOf("blob:") ? (i = Fh(r.src).data, (a = n.findFirst(function (e) {
            return e.base64() === i
        })) ? o({image: r, blobInfo: a}) : Ih(r.src).then(function (e) {
            a = n.create(zh(), e, i), n.add(a), o({image: r, blobInfo: a})
        }, function (e) {
            t(e)
        })) : (a = n.getByUri(r.src)) ? o({image: r, blobInfo: a}) : Ih(r.src).then(function (t) {
            Lh(t).then(function (e) {
                i = Fh(e).data, a = n.create(zh(), t, i), n.add(a), o({image: r, blobInfo: a})
            })
        }, function (e) {
            t(e)
        })
    ...
    function qh(u) {
        ...
        return u.on("setContent", function () {
            ...
            blobCache: l, addFilter: function (e) {
                d.push(e)
            }, uploadImages: b, uploadImagesAuto: C, scanForImages: w, destroy: function () {
    ...
    var $h = function (e, t) {
        ...
        var t, n, r, o, i, a, u, s, c, l, f, d = e.settings, m = e.dom, g = e.selection, p = e.schema,
            h = p.getBlockElements(), v = g.getStart(), y = e.getBody();
        ...
        return ru((i = e, a = i.startContainer, u = i.startOffset, jo.isText(a) ? 0 === u ? _.some(ar.fromDom(a)) : _.none() : _.from(a.childNodes[u]).map(ar.fromDom)), (t = e, n = t.endContainer, r = t.endOffset, jo.isText(n) ? r === n.data.length ? _.some(ar.fromDom(n)) : _.none() : _.from(n.childNodes[r - 1]).map(ar.fromDom)), function (e, t) {
            var n = X(Yh(o), d(Mr, e)), r = X(Gh(o), d(Mr, t));
            return n.isSome() && r.isSome()
        }).getOr(!1);
        var t, n, r, i, a, u
    }, Qh = function (e, t, n, r) {
        var o = n, i = new go(n, o), a = e.schema.getNonEmptyElements();
        do {
    ...
    var iv = function (o, i, a, e, u, t) {
    ...
    }, av = d(iv, tv.Up, Ga, Ja), uv = d(iv, tv.Down, Ja, Ga), sv = function (n) {
        return function (e) {
            return t = n, e.line > t;
            var t
        }
    ...
    }, lv = jo.isContentEditableFalse, fv = Es, dv = function (e, t) {
        ...
        var r, o, i, a, u, s, c, l = ov(U(te(e.getElementsByTagName("*")), gs)), f = U(l, function (e) {
        ...
        var n, r, o, i, a, u
    }, xv = jo.isContentEditableFalse, wv = jo.isContentEditableTrue, Nv = function (e) {
    ...
    }, Rv = jo.isContentEditableTrue, Dv = jo.isContentEditableFalse, Ov = function (e, t) {
        ...
        var p, e, t, a = g.getBody(), o = ds(g.getBody(), function (e) {
        ...
        return fe.ceFalse && (function () {
            ...
            var n, r, i = function (e, t) {
                ...
                return !(!o || !g.dom.isChildOf(o, i) || !1 !== Dv(Ov(g, o))) || o && (n = o, r = i, !(g.dom.getParent(n, g.dom.isBlock) === g.dom.getParent(r, g.dom.isBlock))) && function (e) {
                    ...
                    var n = _u.before(e.firstChild), r = t.next(n);
                    return r && !Lf(r) && !Ff(r)
                }(o)
            };
    ...
    function Fv(z, U) {
        ...
        var j = z.comment ? z.comment : e, V = z.cdata ? z.cdata : e, H = z.text ? z.text : e,
            q = z.start ? z.start : e, $ = z.end ? z.end : e, W = z.pi ? z.pi : e, K = z.doctype ? z.doctype : e;
        return {
            parse: function (e) {
                var t, n, r, d, o, i, a, m, u, s, g, c, p, l, f, h, v, y, b, C, x, w, N, E, S, T, k, _, A, R = 0,
                    ...
                    I = /((java|vb)script|mhtml):/i, L = function (e) {
                        var t, n;
    ...
    var Mv = Fv, zv = function (e, t) {
        ...
        return wa(l)
    }, Uv = {trimExternal: zv, trimInternal: zv}, jv = 0, Vv = 2, Hv = 1, qv = function (g, p) {
        ...
        "fragmented" === t.type ? Xv(t.fragments, e.getBody()) : e.setContent(t.content, {format: "raw"}), e.selection.moveToBookmark(n ? t.beforeBookmark : t.bookmark)
    }, ny = function (e, t) {
    ...
    function ry(u) {
        ...
        return u.on("init", function () {
            ...
            data: l, typing: !1, beforeChange: function () {
                ...
                var e;
                return o.typing && (o.add(), o.typing = !1, i(!1)), 0 < c && (e = l[--c], ty(u, e, !0), d(!0), u.fire("undo", {level: e})), e
            }, redo: function () {
                var e;
                return c < l.length - 1 && (e = l[++c], ty(u, e, !1), d(!0), u.fire("redo", {level: e})), e
            }, clear: function () {
    ...
    var oy, iy, ay = {}, uy = Ht.filter, sy = Ht.each;
    iy = function (e) {
    ...
    var cy = function (e, t) {
    ...
    }, ly = /^(src|href|style)$/, fy = Xt.each, dy = wc.isEq, my = function (e, t, n) {
        ...
        var i = ar.fromDom(t), a = ar.fromDom(e.create(r, o)), u = n ? Wr(i) : $r(i);
            ...
            if (e = Pc(s, e, d, !0), m.split) {
                if (e = Um(e), (t = gy(s, e, !0)) !== (n = gy(s, e))) {
                    if (/^(TR|TH|TD)$/.test(t.nodeName) && t.firstChild && (t = "TR" === t.nodeName ? t.firstChild.firstChild || t : t.firstChild || t), r && /^T(HEAD|BODY|FOOT|R)$/.test(r.nodeName) && /^(TH|TD)$/.test(n.nodeName) && n.firstChild && (n = n.firstChild || n), my(u, t, n)) {
                        ...
                        return i(hy(u, o, !0, "span", {id: "_start", "data-mce-type": "bookmark"})), void p(!0)
                    }
                    if (my(u, n, t)) return o = _.from(n.lastChild).getOr(n), i(hy(u, o, !1, "span", {
                        id: "_end",
                        "data-mce-type": "bookmark"
                    })), void p(!1);
                    t = py(u, t, "span", {id: "_start", "data-mce-type": "bookmark"}), n = py(u, n, "span", {
                        id: "_end",
                        "data-mce-type": "bookmark"
                    }), i(t), i(n), t = p(!0), n = p()
                } else t = n = i(t);
    ...
    }, Ly = Xt.each, Fy = function (g, p, h, r) {
        var e, t, v = g.formatter.get(p), y = v[0], o = !r && g.selection.isCollapsed(), i = g.dom, n = g.selection,
            b = function (n, e) {
                if (e = e || y, n) {
    ...
    }, My = {applyFormat: Fy}, zy = Xt.each, Uy = function (e, t, n, r, o) {
        var i, a, u, s, c, l, f, d;
        null === t.get() && (a = e, u = {}, (i = t).set({}), a.on("NodeChange", function (n) {
            var r = wc.getParents(a.dom, n.element), o = {};
    ...
    }, Vy = Xt.each, Hy = Si.DOM, qy = function (e, t) {
        var n, o, r, m = t && t.schema || di({}), g = function (e) {
            var t, n, r;
        ...
        return e && "string" == typeof e ? (e = (e = e.split(/\s*,\s*/)[0]).replace(/\s*(~\+|~|\+|>)\s*/g, "$1"), Xt.map(e.split(/(?:>|\s+(?![^\[\]]+\]))/), function (e) {
            var t = Xt.map(e.split(/(?:~\+|~|\+)/), $y), n = t.pop();
    ...
    var Jy, Qy = Object.prototype.hasOwnProperty, Zy = (Jy = function (e, t) {
            return t
        }, function () {
            ...
            process: function (e, t, n) {
                ...
                }), o = "BODY" !== o.nodeName ? u.body.firstChild : u.body, s = c.doc, c.doc = u), xp(r, Zy(i, {node: o})), s && (c.doc = s), o) : t;
        ...
        }, pb = Xt.makeMap, hb = Xt.each, vb = Xt.explode, yb = Xt.extend;
    ...
    var Cb = function (e, t, n) {
        ...
        var r = n.selection ? Zy({forced_root_block: !1}, n) : n, o = e.parse(t, r);
        ...
        var a, u, s, c, l, n,
            r = (a = e, n = ["data-mce-selected"], s = (u = t) && u.dom ? u.dom : Si.DOM, c = u && u.schema ? u.schema : di(a), a.entity_encoding = a.entity_encoding || "named", a.remove_trailing_brs = !("remove_trailing_brs" in a) || a.remove_trailing_brs, l = bb(a, c), eb.register(l, a, s), {
                ...
                serialize: function (e, t) {
                    var n = Zy({format: "html"}, t || {}), r = tb.process(u, e, n), o = xb(s, r, n), i = wb(l, o, n);
    ...
    var Tb, kb, _b = Sb, Ab = jo.isContentEditableFalse, Rb = jo.isContentEditableTrue, Db = function (r, a) {
        var u, s, c, l, f, d, m, g, p, h, v, y, i, b, C, x, w, N = a.dom, E = Xt.each, S = a.getDoc(), T = V.document,
            k = Math.abs, _ = Math.round, A = a.getBody();
    ...
    }, Lb = Ar("element", "width", "rows"), Fb = Ar("element", "cells"), Mb = Ar("x", "y"), zb = function (e, t) {
        ...
        var n, r = ar.fromDom(t.commonAncestorContainer), o = uf(r, e), i = U(o, function (e) {
            return xo(e) || bo(e)
        }), a = Wb(o, t), u = i.concat(a.length ? a : So(n = r) ? Vr(n).filter(Eo).fold(q([]), function (e) {
            return [n, e]
        }) : Eo(n) ? [n] : []);
        return W(u, ha)
    }, Xb = function () {
        ...
        return (t = e, n = o[0], ra(n, "table", d(Mr, t))).bind(function (e) {
            var t = o[0], n = o[o.length - 1], r = Hb(e);
        ...
        if ("text" === t.format) return c = e, _.from(c.selection.getRng()).map(function (e) {
            ...
            }, e.cloneContents()), n = wa(t.innerText);
        ...
        var r, o, i, a, u = (r = t, ma(ma({format: "html"}, n), {set: !0, selection: !0, content: r})),
            s = e.selection.getRng(), c = e.getDoc();
    ...
    var sC = function (e, t) {
        ...
        }, mC = d(cC, Su.isAbove, -1), gC = d(cC, Su.isBelow, 1), pC = d(lC, -1, mC), hC = d(lC, 1, gC),
        vC = jo.isContentEditableFalse, yC = Za, bC = function (e, t, n, r) {
            var o = e === Tu.Forwards, i = o ? Lf : Ff;
            if (!r.collapsed) {
                var a = yC(r);
                if (vC(a)) return sg(e, t, a, e === Tu.Backwards, !0)
            }
            var u = Sa(r.startContainer), s = Ps(e, t.getBody(), r);
            ...
            var r, o, i, a, u = Js(e.getBody()), s = d(Ls, u.next), c = d(Ls, u.prev);
        ...
        }, DC = d(RC, mC), OC = d(RC, gC), BC = function (e, t, n, r) {
            ...
            var o, i, a, u, s, c, l = e.selection.getRng(), f = _u.fromRangeStart(l), d = e.getBody();
            if (!t && DC(r, f)) {
            ...
            var e, r, o, i = ar.fromDom(t.getBody()), a = _u.fromRangeStart(t.selection.getRng()), u = Nl(t), s = El(t);
            ...
            return G(W(e, function (e) {
                return Zy({shiftKey: !1, altKey: !1, ctrlKey: !1, metaKey: !1, keyCode: 0, action: o}, e)
            }), function (e) {
            ...
            i.on("keydown", function (e) {
                ...
                !1 === e.isDefaultPrevented() && (t = i, n = a, r = e, o = or.detect().os, XC([{
                    keyCode: rv.RIGHT,
                    action: wC(t, !0)
                }, {keyCode: rv.LEFT, action: wC(t, !1)}, {keyCode: rv.UP, action: NC(t, !1)}, {
                    keyCode: rv.DOWN,
                    action: NC(t, !0)
                }, {keyCode: rv.RIGHT, action: FC(t, !0)}, {keyCode: rv.LEFT, action: FC(t, !1)}, {
                    keyCode: rv.UP,
                    action: MC(t, !1)
                }, {keyCode: rv.DOWN, action: MC(t, !0)}, {keyCode: rv.RIGHT, action: Xd.move(t, n, !0)}, {
                    keyCode: rv.LEFT,
                ...
                }, {keyCode: rv.UP, action: $C(t, !1)}, {keyCode: rv.DOWN, action: $C(t, !0)}], r).each(function (e) {
                    r.preventDefault()
                }))
            })
        }, GC = function (o, i) {
            o.on("keydown", function (e) {
                ...
                !1 === e.isDefaultPrevented() && (t = o, n = i, r = e, XC([{
                    ...
                    keyCode: rv.BACKSPACE,
                    action: KC(ng, t, !1)
                }, {keyCode: rv.DELETE, action: KC(ng, t, !0)}], r).each(function (e) {
                    r.preventDefault()
                }))
                ...
                !1 === e.isDefaultPrevented() && (t = o, n = e, XC([{
                    keyCode: rv.BACKSPACE,
                    action: KC(ud, t)
                }, {keyCode: rv.DELETE, action: KC(ud, t)}], n))
            })
        }, JC = function (e) {
            ...
            var r = ["style", "class"], a = yr(e, function (e, t) {
                return !F(r, t)
            }).t;
            ...
            var t, u, s, i, c, n, r, o, l, f, d, m, g, p, h, v, y, b, C, x = a.dom, w = a.schema,
                N = w.getNonEmptyElements(), E = a.selection.getRng(), S = function (e) {
                    var t, n, r, o = s, i = w.getTextInlineElements();
            ...
            Dg(x, E).each(function (e) {
                ...
                var i, a, u, s, c, l, f, d = t || "P", m = e.dom, g = dx(m, r);
            ...
            return hx(e, Tl(e))
        }, bx = xf([{br: []}, {block: []}, {none: []}]), Cx = function (e, t) {
            return yx(e)
        }, xx = function (n) {
            return function (e, t) {
                return "" === Nl(e) === n
            ...
            var t = Nl(e), n = ZC(e.dom, e.selection.getStart());
        ...
        }, Px = d(Bx, "\xa0"), Ix = d(Bx, " "), Lx = function (e, t, n) {
        ...
        }, Ux = d(zx, !1), jx = d(zx, !0), Vx = d(Mx, !1), Hx = d(Mx, !0), qx = function (e) {
            ...
            var n, t = e.data, r = (n = t.split(""), W(n, function (e, t) {
            ...
            var t, n, r = _u.fromRangeStart(e.selection.getRng()), o = ar.fromDom(e.getBody());
            if (e.selection.isCollapsed()) {
                var i = d(Vl.isInlineTarget, e), a = _u.fromRangeStart(e.selection.getRng());
        ...
        }, cw = or.detect().browser, lw = function (t) {
            var e, n;
            e = t, n = Vi(function () {
                e.composing || nw(e)
            ...
            r.on("keydown", function (e) {
                var t, n;
                !1 === e.isDefaultPrevented() && (t = r, n = e, XC([{keyCode: rv.END, action: EC(t, !0)}, {
                    keyCode: rv.HOME,
                    action: EC(t, !1)
                }], n).each(function (e) {
                    n.preventDefault()
    ...
    function mw(u) {
        var s, n, r, o = Xt.each, c = rv.BACKSPACE, l = rv.DELETE, f = u.dom, d = u.selection, e = u.settings,
    ...
    var gw = function (e) {
            ...
            t.on("click", function (e) {
                3 <= e.detail && function (e) {
                    var t = e.selection.getRng(), n = Su.fromRangeStart(t), r = Su.fromRangeEnd(t);
        ...
        }, Nw = Si.DOM, Ew = function (t, n, e) {
            var r = _h.get(e), o = _h.urls[e] || t.documentBaseUrl.replace(/\/$/, "");
    ...
    var Uw = function (e, t, n) {
        ...
        e.dom.setHTML(e.getBody(), t), sh(r = e) && sc.firstPositionIn(r.getBody()).each(function (e) {
            var t = e.getNode(), n = jo.isTable(t) ? sc.firstPositionIn(t).getOr(e) : e;
    ...
    }, Gw = Si.DOM, Jw = Xt.extend, Qw = Xt.each, Zw = Xt.resolve, eN = fe.ie, tN = function (e, t, n) {
    ...
    var nN, rN, oN, iN = {
        ...
        }, gN = Si.DOM, pN = Xt.explode, hN = Xt.each, vN = Xt.extend, yN = 0, bN = !1, CN = [], xN = [],
        wN = function (t) {
            var n = t.type;
    ...
    vN(oN = {
        ...
        add: function (e) {
            var t = this;
            return CN[e.id] === e || (null === t.get(e.id) && ("length" !== e.id && (CN[e.id] = e), CN.push(e), xN.push(e)), NN(!0), t.activeEditor = e, t.fire("AddEditor", {editor: e}), rN || (rN = function () {
                t.fire("BeforeUnload")
    ...
    var _N, AN, RN = kN, DN = Math.min, ON = Math.max, BN = Math.round, PN = function (e, t, n) {
        var r, o, i, a, u, s;
        ...
        }, relativePosition: PN, findBestRelativePosition: function (e, t, n, r) {
            var o, i;
        ...
        }, create: IN, fromClientRect: function (e) {
        ...
        add: function (e, t) {
            ...
            var t = e.toLowerCase(), n = FN.hasOwnProperty(t) ? FN[t] : null;
    ...
    }, zN = Xt.each, UN = Xt.extend, jN = function () {
    };
    ...
    var VN = Math.min, HN = Math.max, qN = Math.round, $N = function (e, n) {
        var r, o, t, i;
        ...
        callbacks: {}, count: 0, send: function (t) {
            var n = this, r = Si.DOM, o = t.count !== undefined ? t.count : n.count, i = "tinymce_jsonp_" + o;
    ...
    Xt.extend(XN, Cp);
    var YN, GN, JN, QN, ZN = Xt.extend, eE = function (e) {
